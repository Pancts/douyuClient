...
public class ContentMinaThread implements Runnable{
	...
	//EventBus eventBus;
	public ContentMinaThread(String filepath,List<ContentServerVo> contentServerList,JTextField inNum,JButton butnSure,String loginUser,String gid,ToolTipInterface tti,IoSession loginSession /*EventBus eventBus*/){
		//拉起进程同时随机选择登陆服务器
	...
	public void run() {
		...
		ContentMinaHandler  handler = new ContentMinaHandler(filepath,inNum,butnSure,tti,loginSession);
