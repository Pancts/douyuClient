...
//	}
	...
	public String toString() {
		return "DouyuApiDataVo [room_id=" + room_id + ", room_src=" + room_src
				+ ", cate_id=" + cate_id + ", tags=" + tags + ", room_name="
				+ room_name + ", vod_quality=" + vod_quality + ", show_status="
				+ show_status + ", subject=" + subject + ", show_time="
				+ show_time + ", owner_uid=" + owner_uid
				+ ", specific_catalog=" + specific_catalog
				+ ", specific_status=" + specific_status + ", online=" + online
				+ ", nickname=" + nickname + ", show_details=" + show_details
				+ ", url=" + url + ", game_url=" + game_url + ", game_name="
				+ game_name + ", fans=" + fans + ", rtmp_url=" + rtmp_url
				+ ", rtmp_live=" + rtmp_live + ", rtmp_cdn=" + rtmp_cdn
				+ ", owner_avatar=" + owner_avatar  //+ ",  servers=" + servers
				+ ", owner_weight=" + owner_weight + ", use_p2p=" + use_p2p
				+ ", hls_url=" + hls_url + "]";
	}
