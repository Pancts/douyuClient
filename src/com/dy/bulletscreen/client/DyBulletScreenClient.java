...
public class DyBulletScreenClient
{
    ...
    private name.yumao.douyu.swing.ToolSub toolSub;
...
//    }
   ...
   // public String danmupath = "";
    ...
    public void setToolSub(String toolSub){
   
			try {
				this.toolSub = new ToolSub(toolSub);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			if(msg.get("type").equals("chatmsg")){//弹幕消息
				...
				try {
					...
					if(toolSub!=null) {
						...
						String msgs = msg.get("txt");
						
						 if(msgs.startsWith("=")) {
							 msgs = " " + msgs;
					      }
						 
						// Files.write(msgs.getBytes(), toolSub.getfile() );
						 
						toolSub.addSubString( msgs);
					}
